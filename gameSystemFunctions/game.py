...
class Jogo:
    ...
    def desenhar_barra_progresso(self, x, y, largura, altura, progresso):
        ...
        pygame.draw.rect(self.tela, CORES["VERDE"], (x, y, preenchimento_barra, altura))  # Barra verde de progressão

        # Borda da barra (contorno)
        pygame.draw.rect(self.tela, CORES["PRETO"], (x, y, largura, altura), 2)  # Preto, contorno
