...
FONTE_TEXTO_PEQUENO_NEGRITO = pygame.font.SysFont(*FONTES["texto_pequeno"], bold=True)
...
FONTE_TITULO_PEQUENO_NEGRITO_SUBLINHADO = pygame.font.SysFont(*FONTES["titulo_pequeno"], bold=True)
FONTE_TITULO_PEQUENO_NEGRITO_SUBLINHADO.set_underline(True)
